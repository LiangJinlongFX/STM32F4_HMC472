...
#define AD9954_CS 	PDout(7)// PE5	
#define AD9954_SCLK PDout(6)// PE5	
#define AD9954_SDIO PDout(5)// PE5	
#define AD9954_OSK 	PDout(4)// PE5	
#define PS0 				PDout(3)// PB5
#define PS1 				PDout(2)// PE5	
#define IOUPDATE 		PDout(1)// PE5	

#define AD9954_SDO	PDin(0)
#define AD9954_IOSY PDout(15)// PE5	
#define AD9954_RES 	PDout(14)// PE5	 
#define AD9954_PWR 	PDout(13)// PE5
